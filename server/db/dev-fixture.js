          ...
          important: [
            {
              ...
              date: now.toISOString(),
              hasBill: true,
              extractedBill: { payee: "SoFi", amount: 197.50, due_date: relativeDate(8), type: "transfer" },
            },
            {
              id: "mock-icloud-002",
              from: "Edison",
              ...
              date: now.toISOString(),
              hasBill: true,
              extractedBill: { payee: "Edison", amount: 50.00, due_date: relativeDate(12), type: "bill" },
            },
            {
              id: "mock-icloud-003",
              from: "Venmo",
              ...
              date: now.toISOString(),
              hasBill: true,
              extractedBill: { payee: "Venmo (Alex)", amount: 25.00, due_date: relativeDate(0), type: "income" },
            },
          ],
          noise_count: 2,
        },
