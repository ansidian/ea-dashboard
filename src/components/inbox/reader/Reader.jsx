...
import {
  ...
  Sparkles, X, Reply, ArrowUp, ArrowDown,
...
export default function Reader({ email, account, accent, pinned, onAction, onClose, showTriage, showDraft, billOpen, setBillOpen, trashHoldProgress = 0, snoozeHoldProgress = 0 }) {
