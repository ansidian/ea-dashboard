...
export default function ShellHeader({
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onPointerDown={refreshHold?.startHold}
        onPointerUp={refreshHold?.endHold}
        onPointerLeave={() => refreshHold?.endHold?.(false)}
        ...
        style={{
          ...
          border: "1px solid rgba(255,255,255,0.08)",
          background: "rgba(255,255,255,0.03)", color: "rgba(205,214,244,0.85)",
          fontFamily: "inherit", fontSize: 11, fontWeight: 500, letterSpacing: 0.2,
          cursor: refreshing ? "wait" : "pointer",
          display: "inline-flex", alignItems: "center", gap: 5,
          opacity: refreshing || generating ? 0.6 : 1,
        }}
