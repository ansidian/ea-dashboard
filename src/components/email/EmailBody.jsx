    ...
    <div className="flex items-center">
      {trashState === "idle" && (
        <button
          ...
          className="flex items-center gap-1.5 text-[10px] font-medium text-muted-foreground/30 bg-transparent border-none cursor-pointer p-0 font-[inherit] transition-colors duration-150 hover:text-[#f38ba8]"
        >
      ...
      {trashState === "trashing" && (
        <span className="text-[10px] text-muted-foreground/30">Moving to trash…</span>
      )}
    </div>
  );
